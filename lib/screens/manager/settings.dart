        ...
        child: Column(
          children: [
            ...
            Card(
              ...
              child: Column(
                children: [
                  _buildListTile('Company Profile', Icons.business, onTap: () {}),
                  const Divider(height: 1),
                  _buildListTile(
                    'Office Hours',
                    Icons.access_time,
                    trailing: const Text('10:00 AM - 6:00 PM', style: TextStyle(color: Colors.grey, fontFamily: 'Inter')),
                    onTap: () {},
                  ),
                ],
              ),
            ...
            Card(
              ...
              child: Column(
                children: [
                  _buildListTile('Manager Profile', Icons.person, onTap: () {}),
                  const Divider(height: 1),
