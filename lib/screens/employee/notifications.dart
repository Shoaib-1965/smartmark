...
class EmployeeNotificationsPage extends StatefulWidget {
  const EmployeeNotificationsPage({Key? key}) : super(key: key);

  @override
  _EmployeeNotificationsPageState createState() => _EmployeeNotificationsPageState();
}
...
class _EmployeeNotificationsPageState extends State<EmployeeNotificationsPage> {
  final List<_NotificationItem> _notifications = [
    _NotificationItem(
      ...
      subtitle: 'Your salary for September 2023 has been deposited.',
      time: '1 hour ago',
      icon: Icons.payments,
    ),
    _NotificationItem(
      id: '2',
      title: 'Late Arrival',
      subtitle: 'You were marked late on Oct 11.',
      time: '1 day ago',
